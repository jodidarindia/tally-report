#!/usr/bin/env python3
"""
FLOWRA Tally Sync Agent v7 — Lightweight Collection Requests + Purchase Data
...
WHY THIS DOESN'T FREEZE TALLY:
  ...
  This version uses lightweight COLLECTION requests:
    - "Stock Item" collection → 1-2 sec (just master data with opening qty/rate)
    - "Ledger" collection → 1-2 sec (balances + opening balance)
    - "Voucher" collection with monthly filter → 2-5 sec per month
    - Purchase Vouchers, Debit Notes, Sundry Creditors → for cost analysis
...
Setup:
  ...
  3. python tally_sync_agent_v7.py
"""
